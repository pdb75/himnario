...
class CorosScroller extends StatefulWidget {
  CorosScroller({this.himnos, this.mensaje = '', this.buscador = false});
...
class _CorosScrollerState extends State<CorosScroller> {
  ...
  Widget build(BuildContext context) {
    ...
    if (scrollPosition == double.infinity || scrollPosition == double.nan) scrollPosition = 105.0 - 90.0;
    return Stack(
      children: <Widget>[
        widget.himnos.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) => Column(
                      children: <Widget>[
                        Container(
                          color: (scrollPosition - 15) ~/ ((MediaQuery.of(context).size.height - 60 - 129) / length) == index && dragging
