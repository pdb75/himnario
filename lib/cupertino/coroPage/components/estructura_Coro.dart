                    ...
                    style: TextStyle(
                      ...
                      color: Color.fromRGBO(
                        ScopedModel.of<TemaModel>(context).brightness == Brightness.light
                            ? CupertinoTheme.of(context).primaryColor.red
                            : (ScopedModel.of<TemaModel>(context).getAccentColorText() == Colors.white
                                ? Colors.white.red
                                : ScopedModel.of<TemaModel>(context).mainColor.red),
                        ScopedModel.of<TemaModel>(context).brightness == Brightness.light
                            ? CupertinoTheme.of(context).primaryColor.green
                            : (ScopedModel.of<TemaModel>(context).getAccentColorText() == Colors.white
                                ? Colors.white.green
                                : ScopedModel.of<TemaModel>(context).mainColor.green),
                        ScopedModel.of<TemaModel>(context).brightness == Brightness.light
                            ? CupertinoTheme.of(context).primaryColor.blue
                            : (ScopedModel.of<TemaModel>(context).getAccentColorText() == Colors.white
                                ? Colors.white.blue
                                : ScopedModel.of<TemaModel>(context).mainColor.blue),
                        animation,
                      ),
                    ),
                  ),
